...
class LogbookSeeder extends Seeder
{
    public function run()
    {
       ...
       /**HTC Lab Register Questions */
        ...
        $question_test2Comment= Question::create(array("section_id" => $sec_hiv2->id,"identifier"=>"comment1", "name" => "HIV Test-2 Comments", "description" => "Comments", "question_type" =>"3","required" => "0", "info" => "", "score" => "0", "user_id" => "1"));
                //hivtest3
        ...
        $question_test3Comment= Question::create(array("section_id" => $sec_hiv3->id, "identifier"=>"comments2","name" => "HIV Test-3 Comments", "description" => "Comments", "question_type" =>"3", "required" => "0", "info" => "", "score" => "0", "user_id" => "1"));
      
       //finalResults
        $question_finalPositive = Question::create(array("section_id" => $sec_finalResult->id,"identifier"=>"tpositive4", "name" => "Total Positive (P)", "description" => "","question_type" =>"2", "required" => "1", "info" => "Count all Final Results Positive in Column 'r'", "score" => "0", "user_id" => "1"));
       ...
       //test kit consumption summary
        //Test 1
        $question_totalTest1Positive = Question::create(array("section_id" => $sec_consumption->id,"identifier"=>"tpositive1", "name" => "Total Test-1 Positive", "description" => "Total Test-1 Positive","question_type" =>"2", "required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
        ...
        //Test 2
        $question_totalTest2Positive = Question::create(array("section_id" => $sec_consumption->id,"identifier"=>"tpositive2", "name" => "Total Test-2 Positive", "description" => "Total Test-2 Positive","question_type" =>"2", "required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
        ...
        //Test 3
        $question_totalTest3Positive = Question::create(array("section_id" => $sec_consumption->id,"identifier"=>"tpositive3", "name" => "Total Test-3 Positive", "description" => "Total Test-3 Positive","question_type" =>"2", "required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
        ...
        $question_supervisorReview = Question::create(array("section_id" => $sec_other->id,"identifier"=>"","identifier"=>"","name" => "Supervisor Reviewed Done? ( check for supervisor signature)", "description" => "", "question_type" =>"0","required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
        $question_algorithmFollowed = Question::create(array("section_id" => $sec_other->id,"identifier"=>"", "name" => "Algorithm Followed?", "description" => "Aligorithm Followed?", "question_type" =>"0", "required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
    ...
    /**M & E Checklist Questions */
        ...
        $question_auditType= Question::create(array("section_id" => $sec_MEregister->id, "name" => "Type of Audit", "description" => "","question_type" =>"4",  "required" => "1", "info" => "Select One", "score" => "0", "user_id" => "1"));
        ...
        $question_MEstrategy= Question::create(array("section_id" => $sec_MEregister->id, "name" => "Current testing strategy used at the site (Serial vs. Parallel)", "description" => "","question_type" =>"4", "required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
        $question_METest1= Question::create(array("section_id" => $sec_MEregister->id, "name" => "Screening or Test - 1:", "description" => "","question_type" =>"4", "required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
        ...
        $question_METest2= Question::create(array("section_id" => $sec_MEregister->id, "name" => "Confirmatory or Test - 2:", "description" => "","question_type" =>"4", "required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
        ...
        $question_METest3= Question::create(array("section_id" => $sec_MEregister->id, "name" => "Tie-breaker or Test - 3 (if applicable):", "description" => "","question_type" =>"4", "required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
        ...
        $question_affiliation= Question::create(array("section_id" => $sec_Spiregister->id, "name" => "Affilliation (Circle One)", "description" => "","question_type" =>"4", "required" => "1", "info" => "", "score" => "0", "user_id" => "1"));
