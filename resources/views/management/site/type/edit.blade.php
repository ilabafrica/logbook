...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.edit-site-type', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            @endif
            {!! Form::model($siteType, array('route' => array('siteType.update', $siteType->id), 
        'method' => 'PUT', 'id' => 'form-edit-site-type', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
