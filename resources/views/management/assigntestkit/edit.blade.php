...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        'method' => 'PUT', 'id' => 'form-edit-testkit-assigned', 'class' => 'form-horizontal')) !!}
                ...
                <div class="form-group">
                    {!! Form::label('kit_name_id', Lang::choice('messages.kit-name', 1), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                       {!! Form::select('kit_name', array(''=>trans('messages.select-kit-name'))+$testkits,'', 
                            array('class' => 'form-control', 'id' => 'site_name')) !!}
                    </div>
                </div>
                <div class="form-group">
