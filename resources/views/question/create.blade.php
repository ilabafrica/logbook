...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="active">{{ Lang::choice('messages.create-question', 1) }}</li>
        </ol>
    </div>
</div>
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.create-question', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-10 main">
            ...
            @endif
            {!! Form::open(array('route' => 'question.store', 'id' => 'form-add-question', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
                ...
                <div class="form-group">
                    {!! Form::label('name', Lang::choice('messages.name', 1), array('class' => 'col-sm-4 control-label', 'id' => 'name_label')) !!}
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    {!! Form::label('response', Lang::choice('messages.response', 2), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                        <div class="panel panel-default">
                            ...
                            @foreach($answers as $key=>$value)
                                ...
                                <div class="col-md-3">
                                    <label  class="checkbox-inline">
                                        <input type="checkbox" name="answers[]" value="{{ $value->id}}" />{{ $value->name }}
                                    </label>
                                </div>
                                {!! ($cnt%4==0)?"</div>":"" !!}
                            @endforeach
