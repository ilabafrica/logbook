...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="active">{{ Lang::choice('messages.create-pt', 1) }}</li>
        </ol>
    </div>
</div>
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.create-pt', 1) }} </div>
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            @endif
            {!! Form::open(array('route' => 'pt.store', 'id' => 'form-add-pt', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
