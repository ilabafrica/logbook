...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="active">{{ Lang::choice('messages.edit-role', 1) }}</li>
        </ol>
    </div>
</div>
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.edit-role', 1) }} </div>
    <div class="panel-body">
        ...
        'method' => 'PUT', 'id' => 'form-edit-role', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
