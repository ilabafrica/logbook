...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.create-agency', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            @endif
            {!! Form::open(array('route' => 'agency.store', 'id' => 'form-add-agency', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
