   ...
   <div class="panel-body">
        <div class="row">
           ...
           <ul class="nav nav-tabs default">
                <li class="active"><a href="#counties" data-toggle="tab" aria-expanded="true">{!! Lang::choice('messages.county-list', 1) !!}</a></li>            </li>
                ...
                <div class="tab-pane fade active in" id="counties" style="padding-top:20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $county->hq }}</td>
                            <td>
                              <a href="{{ URL::to("subCountyreport/" . $county->id) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i><span> View</span></a>
