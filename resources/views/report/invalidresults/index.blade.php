...
{!! Form::open(array('route' => 'invalidresults.store', 'id' => 'form-invalid-results', 'class' => 'form-horizontal')) !!}
...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.invalid-results', '1') }}</div>
                ...
                <table class="table table-striped table-bordered table-hover search-table">
                    <thead>
                        <tr>
                            ...
                            <th>{{ Lang::choice('messages.algorithm', 1) }}</th>
                            <th>{{ Lang::choice('messages.kit-name', 1) }}</th>                            
                            <th>{{ Lang::choice('messages.test-used', 1) }}</th>
