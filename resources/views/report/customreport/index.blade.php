    ...
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            {!! Form::open(array('route' => 'customreport.store', 'id' => 'form-customreport', 'class' => 'form-horizontal')) !!}
                ...
                <div class="form-group">
                    {!! Form::label('report_id', Lang::choice('messages.select-report', 1), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                        {!! Form::select('report', array(''=>trans('messages.select-report')),'', 
                            array('class' => 'form-control', 'id' => 'report')) !!}
                    </div>
                </div>
                   <div class="form-group">
