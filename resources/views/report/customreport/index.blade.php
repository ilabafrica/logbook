...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> {{ Lang::choice('messages.custom-report', 1) }}
            </li>
        </ol>
    </div>
</div>

{!! Form::open(array('route' => 'customreport.store', 'id' => 'form-customreport', 'class' => 'form-horizontal')) !!}
    <div class="form-group">
        
                    {!! Form::label('start_date', Lang::choice('messages.start-date', 1), array('class' => 'col-sm-2 control-label')) !!}
                    <div class=" col-sm-2 input-group input-append date datepicker" id="date-of-birth" style="margin-left:20px;">
                     ...
                     {!! Form::label('end_date', Lang::choice('messages.end-date', 1), array('class' => 'col-sm-2 control-label')) !!}
                    <div class=" col-sm-2 input-group input-append date datepicker" id="date-of-birth" style="margin-left:20px;">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
                   {!! Form::label('report', Lang::choice('messages.select-report', 1), array('class' => 'col-sm-2 control-label')) !!}
...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.custom-report', '1') }}</div>
                ...
                <table class="table table-striped table-bordered table-hover search-table">
                    <thead>
                        <tr>
                            ...
                            <th>{{ Lang::choice('messages.reporting-period', 1) }}</th>
