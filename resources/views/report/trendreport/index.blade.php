...
{!! Form::open(array('route' => 'trendreport.store', 'id' => 'form-trendreport', 'class' => 'form-horizontal')) !!}
...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.trend-report', '1') }}</div>
                ...
                <table class="table table-striped table-bordered table-hover search-table">
                    <thead>
                        <tr>
                            ...
                            <th>{{ Lang::choice('messages.testing-month', 1) }}</th>
