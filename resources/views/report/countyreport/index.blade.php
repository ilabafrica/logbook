...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> {{ Lang::choice('messages.county-report', 1) }}
            </li>
        </ol>
    </div>
</div>
...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.county-report', '1') }}
    </div>
   <div class="panel-body">
        <div class="row">
            <div class="col-sm-12">
           <ul class="nav nav-tabs default">
                <li class="active"><a href="#counties" data-toggle="tab" aria-expanded="true">{!! Lang::choice('messages.sub-county-list', 1) !!}</a></li>            </li>
                ...
                <div class="tab-pane fade active in" id="counties" style="padding-top:20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{ URL::to("subCountyreport/" . $subCounty->id) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i><span> View</span></a>
