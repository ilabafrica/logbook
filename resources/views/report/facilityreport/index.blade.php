...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> {{ Lang::choice('messages.facility-report', 1) }}
            </li>
        </ol>
    </div>
</div>
...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.facility-report', '1') }}
    <span class="panel-btn">
        <a class="btn btn-sm btn-info" href="{{ URL::to("facilityreport/create") }}" >
   ...
   <div class="panel-body">
        <div class="row">
           ...
           <li class="active"><a href="#facility" data-toggle="tab" aria-expanded="true">{!! Lang::choice('messages.facility-report', 1) !!}</a></li>
            ...
            <div class="tab-pane fade active in" id="facility" style="padding-top:20px;">
