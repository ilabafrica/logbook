...
@endif
   <div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> Logbook data entry for {!! $facility->name !!} at {!! $facility->name !!} </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="col-sm-12">
                                                            {!! Form::text('r_'.$testKit['id'], Input::old('r_'.$testKit['id']), array('class' => 'form-control')) !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="col-sm-12">
                                                            {!! Form::text('nr_'.$testKit['id'], Input::old('nr_'.$testKit['id']), array('class' => 'form-control')) !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="col-sm-12">
                                                            {!! Form::text('inv_'.$testKit['id'], Input::old('inv_'.$testKit['id']), array('class' => 'form-control')) !!}
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::text('intermediate', Input::old('intermediate'), array('class' => 'form-control')) !!}
                                </div>
                            </div>
                        </div>
                    </div>
