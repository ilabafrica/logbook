                ...
                <table class="table table-striped table-bordered table-hover ">
                    <thead>
                        <tr>                          
                            ...
                            <th>{{ Lang::choice('messages.site-name', 1) }}:{{ $parallel->test_site_id}}</th>
                            <th>{{ Lang::choice('messages.algorithm', 1)}}:Parallel</th>
                ...
                <thead>
                 ...
                 <tbody>
                     <tr>                          
                            ...
                            <td>{{ $parallel->test_kit1_id}}</td>
                            <td>{{ $parallel->test_kit2_id}}</td>
                            <td>{{ $parallel->test_kit3_id}}</td>
                        ...
                        <tr>                          
                            ...
                            <td><table  class="table  table-bordered ">                      
                            <td style= "width:100px">{{ $parallel->test_kit1R }}</td>
                            <td style= "width:100px">{{ $parallel->test_kit1NR }}</td>
                            <td style= "width:100px">{{ $parallel->test_kit1Inv }}</td>
                            </table></td>
                            <td><table  class="table  table-bordered ">                      
                            <td style= "width:100px">{{ $parallel->test_kit2R }}</td>
                            <td style= "width:100px">{{ $parallel->test_kit2NR }}</td>
                            <td style= "width:100px">{{ $parallel->test_kit2Inv }}</td></table></td>
                            <td><table  class="table  table-bordered ">                      
                            <td style= "width:100px">{{ $parallel->test_kit3R }}</td>
                            <td style= "width:100px">{{ $parallel->test_kit3NR }}</td>
                            <td style= "width:100px">{{ $parallel->test_kit3Inv }}</td></table></td></td>  
                    ...
                    <tbody>
                        <tr>                          
                            ...
                            <td>{{ $parallel->negative }}</td>
                            <td>{{ $parallel->indeterminate}}</td>
