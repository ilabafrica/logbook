...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.edit-sub-county', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            @endif
            {!! Form::model($subCounty, array('route' => array('subCounty.update', $subCounty->id), 
        'method' => 'PUT', 'id' => 'form-edit-sub-county', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
