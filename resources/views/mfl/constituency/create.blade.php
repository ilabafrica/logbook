...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.create-constituency', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            @endif
            {!! Form::open(array('route' => 'constituency.store', 'id' => 'form-add-constituency', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
