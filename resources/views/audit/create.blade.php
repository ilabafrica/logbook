...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ url('auditType') }}">{{ Lang::choice('messages.audit-type', 1) }}</a>
            </li>
            <li class="active">{{ Lang::choice('messages.create-audit-type', 1) }}</li>
        </ol>
    </div>
</div>
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <div class="col-sm-12 main">
            ...
            @endif
            {!! Form::open(array('route' => 'auditType.store', 'id' => 'form-add-audit-type', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
