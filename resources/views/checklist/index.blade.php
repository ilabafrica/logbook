...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="active">{{ Lang::choice('messages.checklist', 1) }}</li>
        </ol>
    </div>
</div>
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <table class="table table-striped table-bordered table-hover {!! !$checklists->isEmpty()?'search-table':'' !!}">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr @if(session()->has('active_checklist'))
                                {!! (session('active_checklist') == $checklist->id)?"class='warning'":"" !!}
                            @endif
                            >
